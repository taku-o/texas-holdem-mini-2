...
- [x] 4. E2Eテスト追加とスクリーンショットベースライン更新
- [x] 4.1 オールインCPUのカード裏面表示を検証するE2Eテストを追加する
...
- [x] 4.2 ショーダウン/ゲームオーバー時のControls非表示を検証するE2Eテストを追加する
...
- [x] 5. 全体回帰テスト実行と検証
- [x] 5.1 全単体テストの実行と合格確認
  - `npm run test`を実行し、全テストに合格することを確認する
  - _Requirements: 6.1_

- [x] 5.2 全E2Eテストの実行と合格確認
