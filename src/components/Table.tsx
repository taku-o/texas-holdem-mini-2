...
export const Table: React.FC<TableProps> = ({ communityCards, pot, phase }) => {
  return (
    <div className="relative w-full max-w-4xl mx-auto h-[400px] sm:h-[500px] border-[12px] border-green-900/50 rounded-[100px] sm:rounded-[150px] shadow-2xl bg-gradient-to-br from-green-700 to-green-800 flex flex-col items-center justify-center backdrop-blur-sm -z-10 mt-12 sm:mt-16">
      ...
      {/* Pot Area */}
      <div className="z-10 glass-panel px-8 py-3 mb-8 animate-[fade-in_0.5s_ease-out]">
      ...
      {/* Community Cards */}
      <div className="z-10 flex gap-2 sm:gap-4 h-24 sm:h-32 perspective-1000">
